 ...
 * @author Davidcawork
 */
public class MenuCreditsGame extends BasicGameState implements ComponentListener{
    ...
    public MenuCreditsGame(GameContainer container) {
        try{
            fondo = new Sprite("./res/grafico/creditos/creditos.png");
            //creditos = new Sprite("");
            salir = new Sprite("./res/grafico/buttons/boton_atras.png",new Punto(378,695));
