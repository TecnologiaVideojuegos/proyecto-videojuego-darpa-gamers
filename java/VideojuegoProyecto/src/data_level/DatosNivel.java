...
public class DatosNivel {
    ...
    public void datosNivel3(){
        ...
        float[] escena4 = {64,384,320,384,352,384,352,512,352,544,544,544,576,512,640,512,672,512,672,544,736,544,736,512,768,512,800,512,800,672,768,704,768,640,576,640,576,608,288,608,288,448,64,448,64,384};
        float[][] datosMapa = {escena1,escena2,escena3,escena4}; //se guardan los puntos del mapa
        for(int i = 0;i<numEscenas;i++){
            mapas[i] = datosMapa[i];
        } 
